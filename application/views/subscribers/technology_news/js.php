    ...
    function show_description(id) {
        $.ajax({
            ...
            success: function(res) {
                $('#news_desc').modal('open');
                $('#news_title').text(res.success.data.title);
                $('#news_description').html(res.success.data.description);
            }
        });
    }
