    ...
    public function index_post()
    {
        ...
        try {
            ...
            if (($token_data->role == "superadmin" || $token_data->role == "admin") && $token_data->status) {
                ...
                $existing_content = $this->AboutModel->GetAbout($this->input->post('id'));

                if ($existing_content) {

                    $this->form_validation->set_error_delimiters('', '');
                    $this->form_validation->set_rules('id', 'Content ID', 'required|strip_tags|trim');
                    ...
                    $this->form_validation->set_rules('pres_message', 'President\'s Message', 'trim');
                    ...
                    if ($this->form_validation->run() == FALSE) {
                        ...
                        $this->AboutModel->UpdateAbout($this->input->post('id'), $about_data);
