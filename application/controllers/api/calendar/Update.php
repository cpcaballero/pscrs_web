...
class Update extends Rest_lib
{
    ...
    public function index_post()
    {
        ...
        try {
            ...
            $existing_event = $this->CalendarModel->GetCalendarEvent($this->input->post('id'));
            ...
            if ($existing_event) {
                ...
                if ($this->form_validation->run() == FALSE) {
                    ...
                    $event_data = array(
                        ...
                        'updated_by' => $_SESSION['account']['details']['id']
                    );

                    $this->CalendarModel->UpdateEvent($this->input->post('id'), $event_data);
                    ...
                    $audit_data = (object) array(
                        ...
                        'module' => "calendar",
                        'action' => "update Calendar Event - #" . $this->input->post('id') . " :: " . $this->input->post('title'),
                    );
