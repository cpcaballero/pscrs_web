<?php
require_once(APPPATH . 'libraries/Rest_lib.php');
require_once(APPPATH . '/libraries/CreatorJwt.php');
class ConversationsMP extends Rest_lib
{
    ...
    public function index_get($receiver)
    {
        $token = null;
        ...
        try {
            ...
            if ($token_data->status) {
                ...
                if ($this->MessageModel->MP_GetConversations($receiver)) {
                    $message = array(
                        'success' => array(
                            'message' => 'Record/s fetched successfully!',
                            'data' => $this->MessageModel->MP_GetConversations($receiver)
                        )
                    );
