...
class Messages extends Rest_lib
{
    ...
    public function index_get($convo_id)
    {
        ...
        try {
            ...
            if ($token_data->status) {
                ...
                if ($this->MessageModel->GetMessages($convo_id)) {
                    $message = array(
                        'success' => array(
                            'message' => 'Record/s fetched successfully!',
                            'data' => $this->MessageModel->GetMessages($convo_id)
                        )
                    );
        ...
        try {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                if ($token_data->status) {
                    ...
                    $this->MessageModel->SendMessage($message_data);
