...
class Faqs extends Rest_lib
{
    ...
    public function index_post()
    {
        ...
        try {
            ...
            $this->form_validation->set_rules('faqs', 'Frequently Asked Questions', 'required|trim');
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                if (($token_data->role == "superadmin" || $token_data->role == "admin") && $token_data->status) {
                    ...
                    $action = $this->MemberSettingsModel->CreateFaqs($this->input->post('faqs'));
                    ...
                    $this->response(array(
                        'success' => array(
                            'status' => true,
                            'message' => 'FAQs ' . $action . 'd successfully!',
                        )
                    ), Rest_lib::HTTP_OK);
                } else {
            ...
            if (($token_data->role == "superadmin" || $token_data->role == "admin") && $token_data->status) {
                ...
                if ($id) {
                    if ($this->MemberSettingsModel->GetSettings($id)) {
                        ...
                        $this->MemberSettingsModel->DeleteFaqs($id, $data);
