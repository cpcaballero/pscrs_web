...
class Terms extends Rest_lib
{
    ...
    public function index_post()
    {
        ...
        try {
            ...
            $this->form_validation->set_rules('terms_conditions', 'Terms and Conditions', 'required|trim');
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                if (($token_data->role == "superadmin" || $token_data->role == "admin") && $token_data->status) {
                    ...
                    $action = $this->MemberSettingsModel->CreateTerms($this->input->post('terms_conditions'));
                    ...
                    $this->response(array(
                        'success' => array(
                            'status' => true,
                            'message' => 'Terms ' . $action . 'd successfully!',
                        )
                    ), Rest_lib::HTTP_OK);
                } else {
            ...
            if (($token_data->role == "superadmin" || $token_data->role == "admin") && $token_data->status) {
                ...
                if ($id) {
                    if ($this->MemberSettingsModel->GetSettings($id)) {
                        ...
                        $this->MemberSettingsModel->DeleteTerms($id, $data);
