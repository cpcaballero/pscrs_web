    ...
    public function index_post()
    {
        ...
        try {
            ...
            if ($token_data->status) {
                ...
                $this->form_validation->set_rules('id', 'Video', 'required|strip_tags|trim');
                ...
                if ($this->form_validation->run() == FALSE) {
                    ...
                    if ($this->VideoModel->GetVideo($id)) {
                        ...
                        $is_rated = $this->VideoModel->CheckIfRated($this->input->post('active_user'), $id);

                        if (!$is_rated) {
                            $this->VideoModel->RateVideo($data);
                            $message = array(
                                'success' => array(
                                    'status' => true,
