...
class GetLastLogin extends Rest_lib
{
    ...
    public function index_post($type = 'csv')
    {
        $token = null;
        ...
        try {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                if (($token_data->role == "superadmin" || $token_data->role == "admin") && $token_data->status) {
                    ...
                    $report_name = "MemberLastLogin_" . $report_date . ($report_type == "csv"   
                        ?  ".csv" 
                        : ".pdf");
                    if ($report_type == 'csv') {
                        
                        $report_content = $this->ReportsModel->GetLastLogin($report_date, true);
                        ...
                        //////////////////////////// AUDIT TRAIL ////////////////////////////
                            ...
                            $audit_data = (object) array(
                                ...
                                'module' => "report",
                                'action' => "Login exported " . $report_type,
                            );
                        ...
                        $mpdf = new \Mpdf\Mpdf();
                        $report_content = $this->ReportsModel->GetLastLogin($report_date);
                        $report_template = $this->load->view('report_formats/LastLogin_PDF', $report_content, TRUE);
