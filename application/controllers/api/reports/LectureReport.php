...
class LectureReport extends Rest_lib
{
        ...
        try {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                if (($token_data->role == "superadmin" || $token_data->role == "admin") && $token_data->status) {
                    ...
                    $report_name = "Instructional_Lectures_" . $report_date . ($report_type == "csv"   
                        ?  ".csv" 
                        : ".pdf");
                    if ($report_type == 'csv') {
                        
                        $report_content = $this->ReportsModel->GetLectures($report_date, true);
                        ...
                        //////////////////////////// AUDIT TRAIL ////////////////////////////
                            ...
                            $audit_data = (object) array(
                                ...
                                'module' => "report",
                                'action' => "lecture report exported " . $report_type,
                            );
                        ...
                        $mpdf = new \Mpdf\Mpdf();
                        $report_content = $this->ReportsModel->GetLectures($report_date);
                        $report_template = $this->load->view('report_formats/LectureReport_PDF', $report_content, TRUE);
